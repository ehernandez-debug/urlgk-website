    ...
    <div className=\"min-h-screen bg-background\">
      ...
      <div className=\"lg:hidden fixed bottom-0 left-0 right-0 bg-background border-t p-4 flex gap-4 z-50\">
        <Button size=\"lg\" className=\"flex-1\" asChild>
          <Link to={getAgendarUrl(serviceSlug, location.search)} onClick={() => handleCtaClick(\'agendar\', \'sticky_mobile\')}>Agendar Cita</Link>
        </Button>
        <Button size=\"lg\" variant=\"outline\" className=\"flex-1\" asChild>
            <a href={getWhatsAppUrl(serviceSlug)} target=\"_blank\" rel=\"noopener noreferrer\" onClick={() => handleCtaClick(\'whatsapp\', \'sticky_mobile\')}>WhatsApp</a>
        </Button>
      </div>
            ...
            <Card className=\"medical-card shadow-lg border-primary/20\">
              ...
              <CardContent className=\"space-y-6\">\
                ...
                <Button size=\"lg\" variant=\"outline\" className=\"w-full text-base\" asChild>
                    <a href={getWhatsAppUrl(serviceSlug)} target=\"_blank\" rel=\"noopener noreferrer\" onClick={() => handleCtaClick(\'whatsapp\', \'sidebar\')}>
                        <MessageCircle className=\"h-5 w-5 mr-2\" />
                        Contactar por WhatsApp
                    </a>
                </Button>
