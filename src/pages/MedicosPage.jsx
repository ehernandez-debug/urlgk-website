            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-2">
                  ...
                  <Input id="nombre" placeholder="Dr. Nombre Apellido" required onChange={(e) => handleInputChange('nombre', e.target.value)} />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="cedula">Cédula Profesional</Label>
                  <Input id="cedula" placeholder="12345678" required onChange={(e) => handleInputChange('cedulaProfesional', e.target.value)} />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="especialidad">Especialidad</Label>
                  <Input id="especialidad" placeholder="Urología" required onChange={(e) => handleInputChange('especialidad', e.target.value)} />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="hospital">Hospital/Clínica</Label>
                  <Input id="hospital" placeholder="Nombre del Hospital" required onChange={(e) => handleInputChange('hospital', e.target.value)} />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="telefono">Teléfono</Label>
                  <Input id="telefono" type="tel" placeholder="55 1234 5678" required onChange={(e) => handleInputChange('telefono', e.target.value)} />
                </div>
                <Button type="submit" className="w-full cta-button text-lg py-3" disabled={isSubmitting}>
                  {isSubmitting ? 'Enviando...' : 'Solicitar Información Confidencial'}
                </Button>
              </form>
            </CardContent>
          </Card>
