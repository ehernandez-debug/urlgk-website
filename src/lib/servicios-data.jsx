...
export const servicesData = {
  pediatria: {
    'urodinamia-multicanal': {
        ...
        precio: '$12,927 MXN',
        nota_precio: 'Precio con IVA incluido',
        indicaciones: [
  ...
  adultos: {
    ...
    'uroflujometria-premium': {
        ...
        subtitle: 'Evaluación del flujo y del vaciamiento vesical con ultrasonido.',
        icon: <Activity className="h-12 w-12 text-primary" />,
        description: 'Incluye todo lo de la Uroflujometría Básica + Ultrasonido de vejiga pre y post miccional para evaluar el vaciamiento completo.',
        duracion: '30 minutos - 1 hora',
    ...
    'check-up-total': {
        ...
        subtitle: 'El paquete completo: Estudios + Consulta Urológica Especializada.',
        icon: <Stethoscope className="h-12 w-12 text-primary" />,
        description: 'Incluye Uroflujometría Básica + Uroflujometría Premium (con ultrasonido) + Consulta de Urología con especialista. La experiencia más completa en una sola visita.',
        duracion: '1 hora, reporte en 24-48h.',
        ...
        proceso: [
            'Se realiza Uroflujometría Básica para medir el flujo urinario.',
            'Se realiza Uroflujometría Premium con ultrasonido pre y post miccional.',
            'Consulta presencial con urólogo especialista para revisar resultados y evaluación clínica completa.',
            'El especialista analiza los datos, los correlaciona con la información clínica del paciente y redacta un informe.',
            'Se entrega el reporte completo al paciente con plan de tratamiento recomendado.',
        ],
        ventajas: [
            'Paquete completo todo-en-uno con ahorro significativo.',
            'Evaluación integral: estudios + consulta especializada.',
            'Informe médico formal con plan de tratamiento.',
            'Atención personalizada con urólogo certificado.',
            'Ideal para campañas de marketing y pacientes nuevos.',
        ],
        faq: [
            {
  ...
  adultosResumen: [
    ...
    },
    {
      ...
      description: 'Incluye todo lo de la Básica + Ultrasonido de vejiga pre y post miccional.',
      precio: '$3,716 MXN',
      nota_precio: 'Precio con IVA incluido',
    ...
    },
    {
      title: 'Check Up Total',
      id: 'check-up-total',
      description: 'Paquete completo: Básica + Premium + Consulta de Urología.',
      precio: '$5,800 MXN',
      nota_precio: 'Precio con IVA incluido',
      indicaciones: ['Evaluación integral', 'Casos complejos', 'Segunda opinión', 'Pacientes nuevos'],
    },
  ],
};
